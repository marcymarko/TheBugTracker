...
namespace TheBugTracker.Services
{
    public class BTTicketService : IBTTicketService
    {
        ...
        public BTTicketService(ApplicationDbContext context, UserManager<BTUser> userManager, RoleManager<IdentityRole> roleManager, IBTRolesService roleService, IBTProjectService projectService)
        {
            _context = context;
            ...
            try
            {
                if(ticket != null)
                {
                    try
                    {
                        ...
                        // Revisit this line of code when assigning Tickets
        ...
        public async Task<BTUser> GetTicketDevelopersAsync(int ticketId, int companyId)
        {
